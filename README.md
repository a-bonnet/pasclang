...
### Short-term
* Making sure Pasclang always builds with the latest released version of LLVM from the [official website](https://www.llvm.org/), currently LLVM 10.0.0.
