...
// Works as a builder. Each procedure visits a node and updates the type checker's internal state.
...
class TypeChecker : public AST::Visitor
{
    ...
    private:
        ...
        // Builds symbols declarations before definitions to allow several functions recursively call each other.
